...
JNIEXPORT void JNICALL Java_com_zero_licht_ffmpeg_video_1utils_like
    ...
    __android_log_print(ANDROID_LOG_INFO, "main ", "数据看看看看看%d\n",av_stream_index);
    //2、根据视频流索引，获取解码器上下文
    ...
    __android_log_print(ANDROID_LOG_INFO, "main", "哥特式%d  %d",avcodec_context->pix_fmt,AV_PIX_FMT_YUV420P );
